// scripts/migrate-projects-to-sanity.js
import { createClient } from '@sanity/client';
import portfolioInfo from '../src/constants/portfolioInfo.js';
...
if (!process.env.SANITY_TOKEN) {
  ...
  console.error('Example: SANITY_TOKEN=your_token node scripts/migrate-projects-to-sanity.js');
  process.exit(1);
}
