// scripts/migrate-projects-to-sanity-fixed.js
const { createClient } = require('@sanity/client');
// Import từ file tương thích CommonJS
const portfolioInfo = require('./portfolioInfo-cjs');
...
if (!process.env.SANITY_TOKEN) {
  ...
  console.error('Example: SANITY_TOKEN=your_token node scripts/migrate-projects-to-sanity-fixed.js');
  process.exit(1);
}
